...
namespace BestShopEver.Api.Data
{
    public class BestShopEverDbContext : DbContext
    {
        ...
        public BestShopEverDbContext(DbContextOptions<BestShopEverDbContext> options) : base(options)
        {
        }
